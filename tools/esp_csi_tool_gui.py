...
# Form implementation generated from reading ui file 'tools/esp_csi_tool_gui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_router = QtWidgets.QGridLayout(self.groupBox_11)
        self.gridLayout_router.setObjectName("gridLayout_router")
        self.label_delay_2 = QtWidgets.QLabel(self.groupBox_11)
        self.label_delay_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        self.label_delay_2.setObjectName("label_delay_2")
        self.gridLayout_router.addWidget(self.label_delay_2, 0, 0, 1, 1)
        self.lineEdit_router_ssid = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEdit_router_ssid.setMinimumHeight(28)
        self.lineEdit_router_ssid.setMinimumWidth(220)
        self.lineEdit_router_ssid.setObjectName("lineEdit_router_ssid")
        self.gridLayout_router.addWidget(self.lineEdit_router_ssid, 0, 1, 1, 1)
        self.label_duration_2 = QtWidgets.QLabel(self.groupBox_11)
        self.label_duration_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        self.label_duration_2.setObjectName("label_duration_2")
        self.gridLayout_router.addWidget(self.label_duration_2, 0, 2, 1, 1)
        self.lineEdit_router_password = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEdit_router_password.setMinimumHeight(28)
        self.lineEdit_router_password.setMinimumWidth(220)
        self.lineEdit_router_password.setObjectName("lineEdit_router_password")
        self.gridLayout_router.addWidget(self.lineEdit_router_password, 0, 3, 1, 1)
        self.pushButton_router_connect = QtWidgets.QPushButton(self.groupBox_11)
        self.pushButton_router_connect.setMinimumHeight(36)
        self.pushButton_router_connect.setMinimumWidth(120)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.pushButton_router_connect.setFont(font)
        self.pushButton_router_connect.setObjectName("pushButton_router_connect")
        self.gridLayout_router.addWidget(self.pushButton_router_connect, 0, 4, 1, 1, QtCore.Qt.AlignRight)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_router_connect.setStyleSheet(_translate("MainWindow", "QPushButton { padding: 8px 24px; border-radius: 16px; background: #f5f5f5; color: #d32f2f; font-weight: bold; border: 1px solid #d32f2f; } QPushButton:hover { background: #ffeaea; }"))
